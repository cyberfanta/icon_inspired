...
void stamp(
  ...
  if (kDebugMode && useLog) {
    _useLogFunction(
        decoratorChar, tag, message, decoratorCharStart, decoratorCharEnd, extraLine);
...
void _usePrintFunction(String decoratorChar, String tag, String message,
    String decoratorCharStart, String decoratorCharEnd, bool extraLine) {
  if (decoratorChar != "") {
    print('[$tag]: $decoratorChar$message$decoratorChar${extraLine?"\n":""}');
    return;
  }

  if (decoratorCharStart != "" && decoratorCharEnd != "") {
    print('[$tag]: $decoratorCharStart$message$decoratorCharEnd${extraLine?"\n":""}');
    return;
  }
...
void firebaseAnalytics() {
  //TODO: For future implementation of FirebaseAnalytics
}
